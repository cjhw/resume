...
function StaticResume() {
  ...
  const isIncludeTemplate = VALID_TEMPLATE.includes(
    selectTemplate.templateIndex
  )
  const isValidTemplate =
    selectTemplate.templateId && selectTemplate.templateIndex !== -1
    ...
    <div styleName="empty">
      ...
      <div styleName="footer">
        <MyButton
          ...
          onClick={() => {
            shell.openExternal(
              'https://github.com/PDKSophia/visResumeMook/issues/4'
            )
          }}
        >
          贡献模版
